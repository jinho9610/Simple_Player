...
//GLuint triangleShaderProgramID, trianglePositionVertexBufferObjectID, triangleColorVertexBufferObjectID, triangleElementBufferObject;
//
...
//
//	float position[] = {
//	-0.5f, 0.5f, 0.0f, //	idx 0
//	0.5f, 0.5f, 0.0f, //	idx 1
//	0.5f, -0.5f, 0.0f, //	idx 2
//	-0.5f, -0.5f, 0.0f, //	idx 3
//	};
//
//	// 삼각형을 구성하는 정점의 색상
//	float color1[] = {
